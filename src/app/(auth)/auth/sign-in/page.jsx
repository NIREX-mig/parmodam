...
export default function Signin() {
  ...
  return (
    <section className="bg-indigo-100 w-full h-screen text-black flex justify-center items-center pattern " >
      <div className="flex lg:w-[70rem] w-auto bg-white shadow-2xl shadow-black mx-auto rounded-lg border ">
        ...
        <div className="lg:w-[30rem] w-auto mx-auto p-10 flex flex-col justify-center items-center">
          <h2 className="text-black text-center font-semibold lg:text-3xl text-2xl ">Sign In</h2>
          <p className="mt-5 lg:text-lg text-sm text-gray-700 ">Enter your email and password to Sign In.</p>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 w-full mt-10 ">
              <FormField
